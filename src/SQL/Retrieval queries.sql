...
--QUERY 1. For each patient, find the number of healthfriends made in the last month.
SELECT * FROM healthfriend hf WHERE hf.dttm >=  sysdate - INTERVAL '1' month(1);

--QUERY 2. For each patient and each type of observation, show the number of such observations recorded by the patients.
